;(function(parent){
    ...
    var Scroller=(function(){
        ...
        function ScrollerImpl(props){
            ...
            this.scrollPane.setAttribute("style","height:100%;");
            this.table=null;
            this.beginNum=0;
            this.endNum=0;
            this.css=null;
        ...
        ScrollerImpl.prototype={
            init:function(begin,end){
                ...
                this.table.setAttribute("style","margin:auto;height:100%");
            ...
            innerInit:function(maxLength){
                ...
                for(var i=0;i<maxLength;++i){
                    ...
                    // Update props
                    var scrollPanel=new CSSTransitionScrollPanel(this.props).init();
