define(function(){!function(n,o){function e(n,o){return l.cleanObj.toString.call(n).slice(8,-1)===o}function t(n){var o=m[n];if(o)return o.exports;throw"module "+n+" is undefined"}function r(n,o){for(var e,r,i=n.split(":"),a=i.pop().split("/"),s=l;e=a.shift();)"bdbox"!==e&&(r=e,a.length&&(s=s[e]=s[e]||{}));var c=m[n]={exports:{}},u=l.isFunction(o)?o.apply(c,[t,c.exports,c,l]):o;
